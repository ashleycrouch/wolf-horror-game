...
namespace deVoid.Utils
{
    ...
    public abstract class ASignal : ABaseSignal
    {
        ...
        public void Dispatch() {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}");
            if (callback != null) {
                callback();
            }
        }
    ...
    public abstract class ASignal<T> : ABaseSignal
    {
        ...
        public void Dispatch(T arg1) {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}: {arg1?.ToString()}");
            if (callback != null) {
                callback(arg1);
            }
        }
    ...
    public abstract class ASignal<T, U> : ABaseSignal
    {
        ...
        public void Dispatch(T arg1, U arg2) {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}: {arg1?.ToString()}: {arg2?.ToString()}");
            if (callback != null) {
                callback(arg1, arg2);
            }
        }
    ...
    public abstract class ASignal<T, U, V, W, X, Y> : ABaseSignal
    {
        private Action<T, U, V, W, X, Y> callback;

        /// <summary>
        /// Adds a listener to this Signal
        /// </summary>
        /// <param name="handler">Method to be called when signal is fired</param>
        public void AddListener(Action<T, U, V, W, X, Y> handler)
        {
#if UNITY_EDITOR
            UnityEngine.Debug.Assert(
                handler.Method.GetCustomAttributes(typeof(System.Runtime.CompilerServices.CompilerGeneratedAttribute),
        ...
        /// </summary>
        /// <param name="handler">Method to be unregistered from signal</param>
        public void RemoveListener(Action<T, U, V, W, X, Y> handler)
        {
            callback -= handler;
        }
        ...
        /// Dispatch this signal
        /// </summary>
        public void Dispatch(T arg1, U arg2, V arg3, W arg4, X arg5, Y arg6)
        {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}");
            if (callback != null)
            {
    ...
    public abstract class ASignal<T, U, V, W, X, Y, Z> : ABaseSignal
    {
        private Action<T, U, V, W, X, Y, Z> callback;

        /// <summary>
        /// Adds a listener to this Signal
        /// </summary>
        /// <param name="handler">Method to be called when signal is fired</param>
        public void AddListener(Action<T, U, V, W, X, Y, Z> handler)
        {
#if UNITY_EDITOR
            UnityEngine.Debug.Assert(
                handler.Method.GetCustomAttributes(typeof(System.Runtime.CompilerServices.CompilerGeneratedAttribute),
        ...
        /// </summary>
        /// <param name="handler">Method to be unregistered from signal</param>
        public void RemoveListener(Action<T, U, V, W, X, Y, Z> handler)
        {
            callback -= handler;
        }
        ...
        /// Dispatch this signal
        /// </summary>
        public void Dispatch(T arg1, U arg2, V arg3, W arg4, X arg5, Y arg6, Z arg7)
        {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}");
            if (callback != null)
            {
    ...
    public abstract class ASignal<S, T, U, V, W, X, Y, Z> : ABaseSignal
    {
        private Action<S, T, U, V, W, X, Y, Z> callback;

        /// <summary>
        /// Adds a listener to this Signal
        /// </summary>
        /// <param name="handler">Method to be called when signal is fired</param>
        public void AddListener(Action<S, T, U, V, W, X, Y, Z> handler)
        {
#if UNITY_EDITOR
            UnityEngine.Debug.Assert(
                handler.Method.GetCustomAttributes(typeof(System.Runtime.CompilerServices.CompilerGeneratedAttribute),
        ...
        /// </summary>
        /// <param name="handler">Method to be unregistered from signal</param>
        public void RemoveListener(Action<S, T, U, V, W, X, Y, Z> handler)
        {
            callback -= handler;
        }
        ...
        /// Dispatch this signal
        /// </summary>
        public void Dispatch(S arg1, T arg2, U arg3, V arg4, W arg5, X arg6, Y arg7, Z arg8)
        {
            Debug.Log($"{Time.time:f6} - ASignal.Dispatch: {this.GetType().Namespace}.{this.GetType().Name}");
            if (callback != null)
            {
